  ...
  private testProjects: TestProject[] = [
    {
      ...
      project: {
        ...
        recommendedBid: "6500",
        clientInsights: { totalProjects: 10, averageRating: 4.8 },
        marketData: { avgBidCount: 25, avgWinRate: 0.12 },
        createdAt: new Date(),
        updatedAt: new Date()
      },
    ...
    },
    {
      ...
      project: {
        ...
        recommendedBid: "45",
        clientInsights: { totalProjects: 5, averageRating: 4.6 },
        marketData: { avgBidCount: 35, avgWinRate: 0.08 },
        createdAt: new Date(),
        updatedAt: new Date()
      },
    ...
    },
    {
      ...
      project: {
        ...
        matchScore: 72,
        competitionLevel: 'high' as const,
        successPrediction: 55,
        recommendedBid: "4500",
        clientInsights: { totalProjects: 15, averageRating: 4.9 },
        marketData: { avgBidCount: 40, avgWinRate: 0.06 },
        createdAt: new Date(),
        updatedAt: new Date()
      },
    ...
    },
    {
      ...
      project: {
        ...
        clientInsights: { totalProjects: 8, averageRating: 4.7 },
        marketData: { avgBidCount: 15, avgWinRate: 0.20 },
        createdAt: new Date(),
        updatedAt: new Date()
      },
    ...
    },
    {
      ...
      project: {
        ...
        recommendedBid: "3500",
        clientInsights: { totalProjects: 12, averageRating: 4.8 },
        marketData: { avgBidCount: 20, avgWinRate: 0.15 },
        createdAt: new Date(),
        updatedAt: new Date()
      },
